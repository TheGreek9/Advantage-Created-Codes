...
def main():
    ...
    pyautogui.moveTo(1162, 481, duration=1.5)
    pyautogui.click(1162, 481)
    process('Bump')
    pyautogui.moveTo(290, 193, duration=0.5)
    ...
    pyautogui.moveTo(651, 514, duration=1.5)
    pyautogui.click(651, 514)
    pyautogui.click(651, 514)
    pyautogui.click(651, 514)
    focus_terminal("Click store selling and click enter.")
    ...
    pyautogui.moveTo(651, 514, duration=1.5)
    pyautogui.click(651, 514)
    focus_terminal('Click markdown data. Press enter when finished.')
    pyautogui.moveTo(1359, 669, duration=1)
    pyautogui.click(1359, 669)
    pyautogui.moveTo(595, 565, duration=1)
    pyautogui.click(595, 565)
    ...
    pyautogui.moveTo(315, 746, duration=1.5)
    pyautogui.click(315, 746)
    pyautogui.moveTo(1248, 641, duration=1.5)
    pyautogui.click(1248, 641)


def process(week):
    pyautogui.moveTo(418, 196, duration=1)
    pyautogui.click(418, 196)
    pyautogui.moveTo(737, 256, duration = 1.5)
    ...
    pyautogui.click(30, 689)
    pyautogui.click(30, 689)
    pyautogui.moveTo(110, 228, duration=1.5)
    check_color((238, 208, 103))
    pyautogui.moveTo(89, 324, duration=0.5)
...
def process_all(text):
    ...
    pyautogui.moveTo(101, 756, duration=1)
    pyautogui.click(101, 756)
    pyautogui.moveTo(178, 193, duration=2.2)
    pyautogui.click(178, 193)
